...
import {
	...
	IconBox,
	IconCalendarEvent,
	IconChecklist, IconFolderOpen, IconFolderStar,
	IconMessage,
	IconRubberStamp,
...
export function useSideMenu() {
	...
	return useMemo<Array<Array<MagicMenuItemType>>>(() => {
			...
			return [imMenu, aiMenu, extendMenu].reduce<Array<Array<MagicMenuItemType>>>((array, menuGroup) => {
...
export function useAutoCollapsed(collapsed: boolean) {
	...
	return useMemo(
		() => (size?.width ? size?.width < 768 : collapsed),
